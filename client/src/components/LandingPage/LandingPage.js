...
function LandingPage() {
    return (
        <div className='container-thumbnail position-relative'>   
         ...
         <p className="w-50 p-5 mt-5 fs-1 position-absolute top-0 start-30  text-white ">"Keep it easy with these simple but delicious recipes. From make-ahead lunches and midweek meals to fuss-free sides and moreish cakes, we've got everything you need..."</p>
